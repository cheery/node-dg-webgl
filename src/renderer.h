namespace webgl {
    ...
    class Renderer : public node::ObjectWrap {
        public:
            ...
            //static Handle<Value> New(IVideoContext* context);
        ...
        private:
            ...
            inline void MakeCurrentLazy() {
                ...
                dg_context c;
                dgGetCurrent(&d, &r, &c);
                if ((d != draw) || (r != read) || (c != context)) {
                    dgMakeCurrent(draw, read, context);
                }
            }
            ...
            static Handle<Value> Reconfigure(const Arguments& args);
            ...
            static Handle<Value> TextureSourceDG(const Arguments& args);
